          ...
          <Table striped hover>
            <thead>
              <tr>
                ...
                <th>Email</th>
                <th>Branch</th>
                <th>Role</th> {/* Existing Role Column */}
                <th>Change Role</th> {/* New Column for Changing Role */}
            ...
            <tbody className="table-group-divider">
              {filtered?.map((item, index) => (
                <tr key={index}>
                  ...
                  {/* New "Change Role" Column with Dropdown */}
                  <td>
                    <Form.Select
                      value=""  // Set to "" so "Choose One" is initially selected
                      onChange={(e) => handleRoleChange(item, e.target.value)}
                    >
                      <option value="" disabled>Choose One</option> {/* Default option */}
                      <option value="user">Make User</option>
                      <option value="admin">Make Admin</option>
                      <option value="superadmin">Make Super Admin</option>
                    </Form.Select>
                  </td>
